            ...
            {!!Form::model($catalogo, ['route'=>['catalogos.update', $catalogo->id], 'method'=>'PUT', 'files' => true])!!}
				<div class="row">
					...
					<div class="file-field col s6 right centrado">
						<input name="cover" type="radio" id="test1" value="1" @if($catalogo->cover == 1) checked="checked" @endif/>
						<label for="test1">Portada</label>
						<img class="imagen" src="{{ asset('images/catalogo/cover1.jpg') }}" alt="">
						<input name="cover" type="radio" id="test2" value="2" @if($catalogo->cover == 2) checked="checked" @endif/>
