    ...
    <link href="{{ asset('fonts/slick.ttf') }}" rel="fonts/ttf">
    <link href="{{ asset('fonts/slick.woff') }}" rel="fonts/woff">
    
    <link href="https://fonts.googleapis.com/css?family=Fira+Sans:300,400,400i,600,600i,700" rel="stylesheet">
